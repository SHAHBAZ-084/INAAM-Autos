...
process.env.INAAM_USER_DATA = path.join(process.env.APPDATA, 'INAAM AUTOS');
process.env.USMAN_USER_DATA = process.env.INAAM_USER_DATA;
process.env.NODE_ENV = 'production';
const SNAPSHOT = path.join(process.env.INAAM_USER_DATA, 'update-drill-snapshot.json');
...
(async () => {
  ...
  const dbPath = path.join(process.env.INAAM_USER_DATA, 'inaam-autos.db');
