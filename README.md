...
Offline desktop accounting and shop management app for **INAAM Autos**.
...
- SQLite database file: `backend/prisma/data/inaam-autos.db`
...
This uploads the Windows setup exe and `latest.yml` to a GitHub Release tagged with that version (repo: [SHAHBAZ-084/INAAM-Autos](https://github.com/SHAHBAZ-084/INAAM-Autos)).
