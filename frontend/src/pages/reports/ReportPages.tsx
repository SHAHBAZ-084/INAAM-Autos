...
export function AccountReportsPage() {
  ...
  function exportLedger(format: 'pdf' | 'excel') {
    ...
    if (format === 'excel') {
      downloadExcel(`${base}.xlsx`, 'Ledger', headers, rows, reportMeta);
    } else {
      downloadPdf(`${base}.pdf`, title, headers, rows, reportMeta);
    }
  }
...
export function AccountBalancePage() {
  ...
  function exportReport(format: 'pdf' | 'excel') {
    ...
    if (format === 'excel') {
      downloadExcel(`${base}.xlsx`, 'Account Balance', headers, rows, reportMeta);
    } else {
      downloadPdf(`${base}.pdf`, title, headers, rows, reportMeta);
    }
  }
...
export function VouchersReportPage() {
  ...
  function exportReport(format: 'pdf' | 'excel') {
    ...
    if (format === 'excel') {
      downloadExcel(`${base}.xlsx`, 'Vouchers', headers, rows, reportMeta);
    } else {
      downloadPdf(`${base}.pdf`, title, headers, rows, reportMeta);
    }
  }
