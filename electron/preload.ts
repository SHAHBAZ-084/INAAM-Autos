...
contextBridge.exposeInMainWorld('inaamAutos', desktopApi);
contextBridge.exposeInMainWorld('usmanGarments', desktopApi);

declare global {
  interface Window {
    inaamAutos?: typeof desktopApi;
    usmanGarments?: typeof desktopApi;
  }
}
